...
export default function Airtel() {
  ...
  const [montant, setMontant] = useState("2350");
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-blue-400">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <h1 className="text-2xl font-bold text-center text-[#E60000] mb-6">
          Paiement via Airtel
        </h1>
        <form className="space-y-4" onSubmit={submitForm}>
          ...
          <button
            type="submit"
            className="w-full py-2 text-white bg-[#E60000] flex items-center justify-center rounded hover:bg-[#E60000]/80"
          >
            {loading ? 
                <div role="status">
